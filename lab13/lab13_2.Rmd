...
```{r}
ggmap(map2) +
  geom_point(data = sharks_dups, aes( x = longitude, y = latitude), size = 0.4) +
...
```{r}
ggmap(map2) +
  geom_point(data = sharks_fatal, aes( x = longitude, y = latitude), size = 0.4) +
  labs(x= "Longitude", y= "Latitude", title="Fatal Shark Incidents")
```
