...
ui <- fluidPage(
  ...
  selectInput("x", "Select Taxon", choices = c("lake fishes", "river fishes", "marine fishes", "birds", "mammals", "lizards", "snakes", "turtles", "tortoises"), selected = "lake fishes"),
